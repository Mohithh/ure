...
const keyContacts = [
  ...
  {
    name: 'Ramanuj Kumar',
    title: 'Partner (Co-Head - Projects (Energy & Energy Transition))',
    email: 'ramanuj.kumar@cyrilshroff.com',
    initials: 'RK',
  },
];
...
const deals = [
  {
    title: 'Cyril Amarchand Mangaldas acted as the Indian legal counsel to Clean Max Enviro Energy Solutions Limited on its IPO and primary/secondary pre-IPO placement of approximately USD 500 million',
    date: '16/03/2026',
    categories: ['Capital Markets'],
  },
  {
    title: 'CAM represented Eversource Capital and Radiance Renewables on proposed investment by FMO and IFU',
    date: '17/02/2026',
    categories: ['Corporate'],
  },
  {
    title: 'Cyril Amarchand Mangaldas advised ABC Clean Energy on acquisition of 500 MW solar portfolio',
    date: '10/01/2026',
    categories: ['Energy', 'Mergers & Acquisitions'],
  },
  {
    title: 'CAM acted as legal counsel to XYZ Power on hybrid wind-solar project financing of USD 750 million',
    date: '05/12/2025',
    categories: ['Energy', 'Project Finance'],
  },
];

// Energy Sources
const energySources = [
  { category: 'Conventional Sources', items: ['Oil & Gas', 'Thermal Power'] },
  { category: 'Renewable Sources', items: ['Wind Power', 'Solar Power (Grid-connected)', 'Solar Power (Off-grid & Rooftop)', 'Hybrid Power', 'Hydro Power', 'Biomass Energy', 'Waste-to-Energy'] },
  { category: 'Emerging Technologies', items: ['Nuclear Power', 'Energy Storage', 'Electric Vehicles (EV)', 'Offshore Wind', 'Green Hydrogen', 'Carbon Capture', 'Energy Efficiency'] },
];
...
const whyChooseUs = [
  {
    icon: '⚡',
    title: 'Fast-Paced Expertise',
    description: 'Thorough grasp of energy sector\'s complexities and evolving needs',
  },
  {
    icon: '🔋',
    title: 'Full Spectrum Coverage',
    description: 'Conventional, renewable, and emerging energy technologies',
  },
  {
    icon: '🏛️',
    title: 'Regulatory Mastery',
    description: 'Constant interaction with regulators for seamless navigation',
  },
  {
    icon: '🚀',
    title: 'First-of-its-kind',
    description: 'Sector-defining work with marquee, innovative transactions',
  },
];
  ...
  return (
    <div className="bg-[#F4F3EE]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-14">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 space-y-4">
            <p className="text-[#2d2926] text-lg leading-relaxed">
              Energy is a fast-paced sector, with relentless changes and complexities. Given the ever-burgeoning 
              population and demographic changes, energy remains a quintessential need for most developing countries.
            </p>
            <p className="text-[#5a5651] leading-relaxed">
              Our experience spans across the energy sector, including conventional sources such as oil & gas, 
              thermal, and renewable as well as non-conventional energy such as wind, solar (including off-grid 
              and rooftop solar projects), hybrid power, nuclear power, hydro power, bio-mass, waste-to-energy 
              and the areas of both generation and transmission.
            </p>
            <div className="bg-[#fff8f5] border-l-4 border-[#C15F3C] p-5 mt-4">
              <p className="text-sm text-[#2d2926] leading-relaxed">
                <span className="font-semibold text-[#C15F3C]">We advise on all technological and product disruptions</span>{' '}
                including energy storage, electric vehicles, offshore wind and purchase of power through financial settlement.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#C15F3C] p-6 rounded-sm flex flex-col justify-center items-center text-center text-white">
            ...
            <p className="text-sm leading-relaxed">
              Strategic advice on multidisciplinary aspects of the energy sector value chain over its lifecycle
            </p>
          </div>
        </div>
        ...
        {/* Energy Sources - Comprehensive Grid */}
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-[#2d2926] mb-6 relative inline-block after:content-[''] after:absolute after:bottom-[-8px] after:left-0 after:w-full after:h-[2px] after:bg-[#C15F3C]">
            Energy Sources We Cover
          </h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            {energySources.map((source, idx) => (
              <div key={idx} className="bg-white border border-[#e0dbd5] rounded-sm p-5 hover:shadow-md transition-all">
                <h3 className="text-lg font-semibold text-[#C15F3C] mb-4 pb-2 border-b border-[#f0e6e0]">
                  {source.category}
                </h3>
        ...
        {/* Services & Why Choose Us - Two Column */}
          ...
          <div className="bg-gradient-to-r from-[#C15F3C]/10 to-transparent p-8 rounded-sm border border-[#e0dbd5]">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-xl font-semibold text-[#2d2926] mb-2">Unmatched Regulatory Expertise</h3>
                <p className="text-sm text-[#5a5651] leading-relaxed">
                  Our attorneys have in-depth knowledge and experience in the energy sector and are fully 
                  conversant with the needs of clients, both global and domestic. Owing to our constant 
                  interaction with regulators in India, coupled with our legal expertise, we are well poised 
                  to support our clients and help them navigate through the country's complex regulatory regime.
                </p>
              </div>
            </div>
          </div>
