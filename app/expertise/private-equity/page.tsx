...
export default function PrivateEquityPage() {
  ...
  const pillars = [
    {
      title: "Buyouts & Growth Capital",
      desc: "Advising on control transactions, minority investments, and PIPEs across sectors, with a focus on deal structuring and governance."
    },
    {
      title: "Exit Strategies & Liquidity",
      desc: "Comprehensive support for exits via IPOs, secondary sales, or strategic buy-backs, ensuring maximum value realization for investors."
    },
    {
      title: "Fund Portfolio Management",
      desc: "Post-investment legal support, including add-on acquisitions, compliance monitoring, and handling complex shareholder dynamics."
    }
  ];

  const highlights = [
    { title: "Preferred", value: "Choice", desc: "Recognized as the firm of choice for top international and domestic multilateral institutions." },
    { title: "Lifecycle", value: "Expertise", desc: "Deep understanding of the investment lifecycle—from entry and growth to complex exit structures." },
    { title: "Regulatory", value: "Nuance", desc: "Expertise in navigating SEBI, FDI, and sectoral regulations that impact the private equity ecosystem." },
  ];

  return (
    <PageTemplate
      title="Private Equity"
      subtitle="Extensive knowledge and expertise in advising global and domestic capital on high-stakes investments."
      category="Expertise"
      breadcrumb="Private Equity"
      heroImage="/images/practice/private-equity-hero.jpg"
      showHero={true}
      ...
      <article className="space-y-12 transition-all duration-500">
        <section>
          ...
          <p className="text-lg text-black/80 leading-relaxed font-light">
            Our Private Equity team possesses extensive knowledge and expertise that makes it the firm of choice for top international 
            and domestic multilateral institutions, sovereign wealth funds, and venture capital houses.
          </p>
          <p className="mt-4 text-lg text-black/80 leading-relaxed font-light">
            We provide strategic advisory throughout the investment lifecycle, from structuring and due diligence to negotiations and exits, 
            ensuring that our clients' capital is deployed and managed with the highest level of legal certainty.
          </p>
        </section>
...
function PracticeContactHead({ onConnect }: { onConnect: () => void }) {
  return (
    <div className="bg-[#cbc7bf]/30 p-8 flex flex-col items-center text-center rounded-sm">
      ...
      <p className="text-[#C15F3C] font-semibold text-sm mb-4">Partner (Head - Private Equity)</p>
