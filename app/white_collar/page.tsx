...
const keyContacts = [
  {
    name: 'Ankoosh K Mehta',
    title: 'Partner (Co-Head – White Collar & Investigation)',
    email: 'ankooshk.mehta@cyrilshroff.com',
    initials: 'AM',
  },
];
...
const publications = [
  ...
  {
    title: 'Investigations and White Collar Crimes Enforcement Trends',
    type: 'Publications',
    icon: '📘',
  },
  {
...
const strengths = [
  {
    value: 'Unbeaten',
    label: 'Track Record',
    description: 'Managing complex and high-stakes probes across jurisdictions',
  },
  {
    value: 'End-to-End',
    label: 'Investigation Capability',
    description: 'Only Indian law firm offering complete investigation solutions',
  },
  {
    value: 'Multi-Disciplinary',
    label: 'Expert Teams',
    description: 'Quick setup of teams for comprehensive advice across all facets',
  },
];
...
const whyChooseUs = [
  {
    ...
    description: 'Team comprising exemplary former regulators from SEBI, RBI, and MCA',
  },
  {
    icon: '🌍',
    title: 'Global Expertise',
    description: 'Experience in SEC, FCPA, UKBA investigations worldwide',
  },
  {
    icon: '🛡️',
    title: 'Tailored Advice',
    description: 'Focus on tailoring advice specific to nature and scope of investigations',
  },
  {
    icon: '⚡',
    title: 'Crisis Management',
    description: 'Safeguarding long-term interests during regulatory and criminal crises',
  },
];

export default function WhiteCollarInvestigationsPage() {
  return (
    <div className="bg-[#F4F3EE]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-14">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 space-y-4">
            <p className="text-[#2d2926] text-lg leading-relaxed">
              Our expertise in white-collar advisory and investigations is rooted in the team's deep 
              knowledge and understanding of the complexities, risks, technical legal requirements, 
              sensitivity of regulatory and investigative actions.
            </p>
            <p className="text-[#5a5651] leading-relaxed">
              We have extensive relevant experience in enforcement action by the ED, the SEBI, the RBI, 
              and the Ministry of Corporate Affairs. Our team, comprising former exemplary regulators 
              from the SEBI, the RBI, and the MCA, has the bespoke regulatory and sectoral expertise, 
              experience, and credibility our clients can always trust during all regulatory, criminal, 
              and investigative crises.
            </p>
            <div className="bg-[#fff8f5] border-l-4 border-[#C15F3C] p-5 mt-4">
              <p className="text-sm text-[#2d2926] leading-relaxed">
                <span className="font-semibold text-[#C15F3C]">Global reach:</span> We have wide-ranging 
                experience in advising and representing clients globally in SEC, FCPA, UKBA investigations.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#C15F3C] p-6 rounded-sm flex flex-col justify-center items-center text-center text-white">
            ...
            <p className="text-sm leading-relaxed">
              Internal and whistle-blower investigations that are effective, competitive, and sensitive 
              to our clients' needs
            </p>
          </div>
        </div>

        {/* Key Strengths - Three Column Stats Cards */}
        <div className="mb-16">
        ...
        {/* Regulatory Bodies & Practice Areas - Two Column */}
          ...
          <div className="bg-gradient-to-r from-[#C15F3C] to-[#8B3A1E] p-8 rounded-sm text-white">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-1">End-to-End Investigation Capability</h3>
