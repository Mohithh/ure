      ...
      <div className="relative w-full min-h-[400px] bg-gradient-to-br from-[#2d2926] to-[#4a3b35] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 px-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#F4F3EE]/90 font-light italic">
            Your gateway to Indian legal expertise in Southeast Asia
          </p>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              <p className="text-[#2d2926] text-base leading-relaxed mb-4">
                Cyril Amarchand Mangaldas (CAM) announced the opening of its new foreign law practice 
                in Singapore (<span className="font-semibold text-[#C15F3C]">CAM Singapore</span>). 
                CAM Singapore operates as a licensed foreign law practice offering Indian law expertise 
                including International Arbitration.
              </p>
              <p className="text-[#5a5651] text-sm leading-relaxed">
                Singapore is one of the leading business hubs in the world and enjoys a key role as a 
                gateway to India. CAM aims to assist companies in Singapore and the region in navigating 
                through the Indian legal and regulatory framework.
              </p>
            </div>
            ...
            <div>
              <p className="text-sm text-[#5a5651]">
                CAM Singapore resident Partner is{' '}
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="#" className="w-8 h-8 rounded-full bg-white border border-[#e0dbd5] flex items-center justify-center hover:bg-[#C15F3C] hover:text-white hover:border-[#C15F3C] transition-all group">
                <span className="text-xs text-[#5a5651] group-hover:text-white">y</span>
              </Link>
