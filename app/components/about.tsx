  ...
  return (
    <div className="w-full bg-white py-20 px-6 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 lg:gap-24">
        {/* ABOUT US */}
        <div className="flex flex-col justify-between p-[30px] bg-[#F8F6F1] rounded-[10px] border-2 border-[#E8E3D9]">
          ...
          <p className="text-sm leading-7 text-[#C15F3C] mb-8">
            ...
            equity and venture capital funds, start-ups, government and
            regulatory bodies.
          </p>
        ...
        <div className="flex flex-col justify-between p-[30px] bg-[#F8F6F1] rounded-[10px] border-2 border-[#E8E3D9]">
          <div>
            <h2 className="text-3xl font-medium mb-6 text-[#C15F3C]">
              Our People
            </h2>
