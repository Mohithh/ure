...
const deals = [
  {
    title: 'Cyril Amarchand Mangaldas advised RBI on first-ever masala bond issuance by Indian entity',
    date: '15/03/2026',
    categories: ['Debt Markets', 'Masala Bonds'],
  },
  {
    title: 'CAM acted as legal counsel to SBI on $1.25 Billion Regulatory Capital Transaction',
    date: '28/02/2026',
    categories: ['Debt Markets', 'Regulatory Capital'],
  },
  {
    title: 'Cyril Amarchand Mangaldas advised HDFC on MTN Programme worth $5 Billion',
    date: '10/01/2026',
    categories: ['Debt Markets', 'MTN Programme'],
  },
  {
    title: 'CAM acted as legal advisor to ICICI Bank on High-Yield Bond Issuance',
    date: '05/12/2025',
    categories: ['Debt Markets', 'High-Yield Bonds'],
  },
];
...
const debtProducts = [
  ...
  'Listed Securitized Instruments',
  'Masala Bonds',
  'MTN Programmes (Medium Term Notes)',
  'Green Bonds',
  'Social Bonds',
...
const whyChooseUs = [
  {
    icon: '📈',
    title: 'Market-Leading Experience',
    description: 'Advising both issuers and underwriters across all debt capital markets products',
  },
  {
    icon: '🌍',
    title: 'Cross-Border Expertise',
    description: 'Seamless handling of international and domestic debt transactions',
  },
  {
    icon: '🏦',
    title: 'Large Institution Focus',
    description: 'Adept at advising on fund requirements of large institutions',
  },
  {
    icon: '⚡',
    title: 'Innovative Structures',
    description: 'Pioneering first-of-its-kind debt market transactions in India',
  },
];
...
export default function DebtMarketsPage() {
  return (
      ...
      <div className="relative w-full min-h-[400px] bg-gradient-to-br from-[#2d2926] to-[#4a3b35] flex items-center justify-center text-center">
        ...
        <div className="relative z-10 px-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#F4F3EE]/90 font-light italic">
            Adept at advising on fund requirements of large institutions
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-14">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 space-y-4">
            <p className="text-[#2d2926] text-lg leading-relaxed">
              Noted for the depth and breadth of our Debt Markets practice, our team brings the necessary 
              expertise to meet the continuously evolving and diverse funding requirements of the largest 
              institutions and sophisticated companies.
            </p>
            <p className="text-[#5a5651] leading-relaxed">
              We have market-leading experience advising both issuers and underwriters across the whole 
              spectrum of debt capital markets products including high-yield bonds, regulatory capital 
              transactions, listed securitized instruments, masala bonds and MTN programmes.
            </p>
            <div className="bg-[#fff8f5] border-l-4 border-[#C15F3C] p-5 mt-4">
              <p className="text-sm text-[#2d2926] leading-relaxed">
                <span className="font-semibold text-[#C15F3C]">Our Debt Markets practice</span> is at the 
                forefront of innovative financing solutions, helping clients navigate complex regulatory 
                frameworks and access global capital markets efficiently.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#C15F3C] p-6 rounded-sm flex flex-col justify-center items-center text-center text-white">
            ...
            <p className="text-sm leading-relaxed">
              Advising both issuers and underwriters across the whole spectrum of debt capital markets products
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-semibold text-[#2d2926] mb-6 relative inline-block after:content-[''] after:absolute after:bottom-[-8px] after:left-0 after:w-full after:h-[2px] after:bg-[#C15F3C]">
            Debt Products We Advise On
          </h2>
          <p className="text-[#5a5651] mb-6 leading-relaxed text-sm">
            Our comprehensive coverage spans the entire debt capital markets spectrum:
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {debtProducts.map((product, idx) => (
          ...
          <div className="bg-gradient-to-r from-[#C15F3C]/10 to-transparent p-8 rounded-sm border border-[#e0dbd5]">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-xl font-semibold text-[#2d2926] mb-2">Market Leadership in Debt Markets</h3>
                <p className="text-sm text-[#5a5651] leading-relaxed">
                  Our team has been consistently ranked as a top-tier Debt Markets practice by leading 
                  international legal directories including Chambers Asia-Pacific, Legal 500, and IFLR1000. 
                  We continue to set benchmarks with innovative first-of-its-kind transactions.
                </p>
              </div>
            </div>
          </div>
